...
describe('StreamingMessageParser', () => {
  ...
  describe('valid artifacts with actions', () => {
    ...
    it('should parse shell action runtime metadata', () => {
      ...
      parser.parse(
        'message_1',
        'Before <boltArtifact title="Some title" id="artifact_1"><boltAction type="shell" summary="Start preview server" background="true" waitForPort="5275">cd preview && npm run dev</boltAction></boltArtifact> After',
      );
